        ...
        <div className="col-sm-auto col-md-3">
          ...
          >
            ...
            <li className="nav-item">
              <a className="nav-link setinha" href="prae.html">
                PRAE - ASSUNTOS ESTUDANTIS
              </a>
            </li>
            <li className="nav-item">
              <a className="nav-link setinha" href="proec.html">
                PROEC - EXTENSÃO E CULTURA
              </a>
            </li>
            <li className="nav-item">
              <a className="nav-link setinha" href="proeg.html">
                PROEG - ENSINO DE GRADUAÇÃO
              </a>
            </li>
            <li className="nav-item">
              <a className="nav-link setinha" href="prppg.html">
                PRPPG - PESQUISA E PÓS-GRADUAÇÃO
              </a>
            </li>
            <li className="nav-item">
              <a className="nav-link setinha" href="prad.html">
                PRAD - ADMINISTRAÇÃO
              </a>
            </li>
            <li className="nav-item">
              <a className="nav-link setinha" href="pfg.html">
                PGF - GESTÃO FINANCEIRA
              </a>
            </li>
            <li className="nav-item">
              <a className="nav-link setinha" href="prpti.html">
